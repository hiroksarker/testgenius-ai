// TestGenius AI - The Internet Test Examples
// Using https://the-internet.herokuapp.com/ for comprehensive testing

export const FORM_AUTHENTICATION_TEST = {
  id: "INTERNET-001",
...
export const DYNAMIC_CONTENT_TEST = {
  id: "INTERNET-004",
...
export const JAVASCRIPT_ALERTS_TEST = {
  id: "INTERNET-006",
...
export const ADD_REMOVE_ELEMENTS_TEST = {
  id: "INTERNET-007",
...
export const SLOW_RESOURCES_TEST = {
  id: "INTERNET-010",
...
export const BROKEN_IMAGES_TEST = {
  id: "INTERNET-011",
...
export const CHALLENGING_DOM_TEST = {
  id: "INTERNET-012",
