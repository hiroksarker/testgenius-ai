// Authentication Tests for TestGenius AI
// These tests demonstrate how to write tests in plain English

export const LOGIN_SUCCESS_TEST = {
  id: "AUTH-001",
...
export const LOGIN_FAILURE_TEST = {
  id: "AUTH-002",
...
export const REGISTRATION_TEST = {
  id: "AUTH-003",
...
export const PASSWORD_RESET_TEST = {
  id: "AUTH-004",
